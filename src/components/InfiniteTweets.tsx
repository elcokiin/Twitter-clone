...
function HeartButton({ likedByMe, likeCount }: HeartButtonProps ) {
    ...
    return (
        <button className={`-ml-2 group items-center gap-1 self-start flex transition-colors duration-200 ${likedByMe ? "text-red-500" : "text-gray-500"} hover:text-red-400 focus-visible:text-red-400`}>
